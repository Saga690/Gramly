    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="main-center col-span-2 space-y-4">
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                ...
                <p>And again, as before, she unzipped my fly, took out my penis, and put it in her mouth</p>
        ...
        <div class="main-right col-span-1 space-y-4">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            ...
                            <p class="text-xs"><strong>Kendall Jenner</strong></p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            ...
                            <p class="text-xs"><strong>Kim Kardashian</strong></p>
                        </div>
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        <p class="text-xs">
                            <strong>#kyliechalamet</strong><br>
