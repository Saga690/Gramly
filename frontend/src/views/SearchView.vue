    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="main-left col-span-3 space-y-4">
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg grid grid-cols-4 gap-4" v-if="users.length">
                <div class="p-4 text-center bg-gray-100 rounded-lg space-y-5" v-for="user in users" v-bind:key="user.id">
                    <div class="relative w-full pb-[100%] rounded-full overflow-hidden">
                        <img :src="user.get_avatar" class="absolute top-0 left-0 w-full h-full object-cover">
                    </div>
